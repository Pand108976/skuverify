    ...
    <div className="min-h-screen bg-gradient-to-br from-background to-muted/50">
      ...
      <main className="max-w-7xl mx-auto p-6">
        <Tabs defaultValue="search" className="w-full">
          <TabsList className={`${isAdmin ? 'flex justify-start overflow-x-auto' : 'grid grid-cols-5'} w-full bg-background border premium-shadow h-10 text-xs p-0`}>
            ...
            {!isAdmin && (
              <>
                <TabsTrigger value="glasses" className="flex items-center justify-center h-9 text-sm px-1 py-1 data-[state=active]:gold-gradient data-[state=active]:text-white">
                  <Glasses size={14} />
                  <span className="hidden md:inline ml-1 text-sm">Óculos</span>
                </TabsTrigger>
                <TabsTrigger value="belts" className="flex items-center justify-center h-9 text-sm px-1 py-1 data-[state=active]:gold-gradient data-[state=active]:text-white">
            ...
            {!isAdmin && (
              <TabsTrigger value="sales" className="flex items-center justify-center h-9 text-sm px-1 py-1 data-[state=active]:gold-gradient data-[state=active]:text-white">
                <ShoppingCart size={14} />
                <span className="hidden md:inline ml-1 text-sm">Vendas</span>
              </TabsTrigger>
            )}

            <TabsTrigger value="add" className="flex items-center justify-center h-9 text-sm px-1 py-1 data-[state=active]:gold-gradient data-[state=active]:text-white">
              <Plus size={14} />
